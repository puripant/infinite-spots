...
function load() {
  for (let i = 0; i < 1000; i++) {
    ...
    let red = rand(0, 255);
    let blue = rand(0, 255);
    let green = constrain(Math.floor((red + blue) / 2) + rand(0, 100), 0, 255); //from x/3 + y/3 -2z/3 = 0
    let color_string = `rgb(${constrain(red + rand(0, 100), 0, 255)}, ${green}, ${constrain(blue + rand(0, 100), 0, 255)})`;
